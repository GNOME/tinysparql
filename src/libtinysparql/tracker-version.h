...
#define TRACKER_VERSION_3_11 G_ENCODE_VERSION (3, 11)
...
/* 3.11 */
#if TRACKER_VERSION_MIN_REQUIRED >= TRACKER_VERSION_3_11
#define TRACKER_DEPRECATED_IN_3_11 _TRACKER_DEPRECATED
#define TRACKER_DEPRECATED_IN_3_11_FOR(f) _TRACKER_DEPRECATED_FOR(f)
#else
#define TRACKER_DEPRECATED_IN_3_11 _TRACKER_EXTERN
#define TRACKER_DEPRECATED_IN_3_11_FOR(f) _TRACKER_EXTERN
#endif

#if TRACKER_VERSION_MAX_ALLOWED < TRACKER_VERSION_3_11
#define TRACKER_AVAILABLE_IN_3_11 _TRACKER_UNAVAILABLE(3, 11)
#else
#define TRACKER_AVAILABLE_IN_3_11 _TRACKER_EXTERN
#endif
