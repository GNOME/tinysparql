...
#define TRACKER_METHOD_SEARCH_METADATA_BY_TEXT_MIME     	"SearchMetadataByTextAndMime"
#define TRACKER_METHOD_SEARCH_METADATA_BY_TEXT_MIME_LOCATION	"SearchMetadataByTextAndMimeAndLocation"
#define TRACKER_METHOD_SEARCH_METADATA_BY_TEXT_LOCATION	        "SearchMetadataByTextAndLocation"
...
typedef enum {
	...
	DBUS_ACTION_SEARCH_BY_TEXT_MIME,
	DBUS_ACTION_SEARCH_BY_TEXT_MIME_LOCATION,
	DBUS_ACTION_SEARCH_BY_TEXT_LOCATION,
