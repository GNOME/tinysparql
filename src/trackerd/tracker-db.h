...
void		tracker_db_save_metadata	(DBConnection *db_con, GHashTable *table, long file_id, gboolean new_file);
...
void		tracker_db_insert_pending_file	(DBConnection *db_con, long file_id, const char *uri, const char *mime, int counter, TrackerChangeAction action, gboolean is_directory, gboolean is_new);
